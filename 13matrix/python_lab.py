...
## Task 13
cartesian_product = [[x,y] for x in ['A','B','C'] for y in [1,2,3]] # use form: [ ... for x in {'A','B','C'} for y in {1,2,3} ... ]
...
## Task 19
L = ['A','B','C','D','E']
range_and_zip = list(zip(list(range(0,5)),L))
...
## Task 24
D = {'red','white','blue'}
identity_dict = {d:True for d in D}
